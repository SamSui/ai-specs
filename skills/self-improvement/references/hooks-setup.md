---
title: Hook Setup Guide
author: 顾小宇
tags: [技能, AI协作, 自我改进, Hook]
description: 为 AI 编码代理配置自动自我改进触发器的完整指南。
---
    ...
    "UserPromptSubmit": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.openclaw/skills/self-improvement/scripts/activator.sh"
          }
        ]
      }
    ],
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.openclaw/skills/self-improvement/scripts/error-detector.sh"
          }
        ]
      }
    ]
...
```bash
~/.openclaw/skills/self-improvement/scripts/extract-skill.sh test-skill --dry-run
```
...
```bash
chmod +x ~/.openclaw/skills/self-improvement/scripts/activator.sh
chmod +x ~/.openclaw/skills/self-improvement/scripts/error-detector.sh
chmod +x ~/.openclaw/skills/self-improvement/scripts/extract-skill.sh
```
