...
author: 顾小宇
tags: [技能, AI协作, 自我改进, OpenClaw]
description: 自我改进技能与 OpenClaw 集成的完整设置和使用指南。
---
...
```bash
cp -r self-improvement ~/.openclaw/skills/
```
...
```bash
mkdir -p ~/.openclaw/skills/self-improvement/.learnings
```
